...
# Exemplos: "PPOV1", "PPOV1_V2", "PPOV1_SCALPER", "PPOV1_SWING", etc.
EXPERIMENT_TAG = "PPOV1"
...
REALISTIC_SLTP_CONFIG = {
    ...
    'sl_min_points': 8,     # SL mínimo: 8 pontos
    'sl_max_points': 25,    # SL máximo: 25 pontos  
    'tp_min_points': 12,    # TP mínimo: 12 pontos
    'tp_max_points': 40,    # TP máximo: 40 pontos
