...
## Desafio - API de Gerenciamento de Pedidos

O desafio prático foi **implementado com sucesso** e está disponível na pasta `order-api/` deste repositório.

### Acesso à Implementação

- **Código fonte:** [order-api/](./order-api/)
- **Documentação completa:** [order-api/README.md](./order-api/README.md)
...
Para mais detalhes, consulte a [documentação completa da API](./order-api/README.md).

---

**Desenvolvido por Eduardo Peiter**
**Data:** 29/11/2025
**Teste Técnico:** Jitterbit - Professional Services
