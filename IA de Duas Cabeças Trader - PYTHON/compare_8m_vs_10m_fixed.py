...
CHECKPOINT_10M = "D:/Projeto/Otimizacao/treino_principal/models/DAYTRADER/DAYTRADER_phase5integration_10000000_steps_20250812_003213.zip"
...
def test_checkpoint(checkpoint_path, checkpoint_name):
    ...
    try:
        ...
        # Processar dataset - IGUAL A AVALIAÇÃO ANTERIOR
        ...
        # Parâmetros de trading - IGUAIS À AVALIAÇÃO ANTERIOR
        trading_params = {
        ...
        # Executar testes - IGUAL À AVALIAÇÃO ANTERIOR
        ...
        for episode_num in range(NUM_EPISODES):
            ...
            # Selecionar pedaço do dataset - IGUAL À AVALIAÇÃO ANTERIOR
            ...
            # Criar ambiente - IGUAL À AVALIAÇÃO ANTERIOR
            env = TradingEnv(
                episode_df,
                window_size=20,
                is_training=False,
            ...
            while not done and step < TEST_STEPS:
                # Predição em modo inferência - deterministic=False IGUAL ANTES
                action, lstm_states = model.predict(obs, state=lstm_states, deterministic=False)
                obs, reward, done, info = env.step(action)
                
                # Log da ação - IGUAL À AVALIAÇÃO ANTERIOR
                actions_log.append({
                    'step': step,
        ...
        # Análise final - IGUAL À AVALIAÇÃO ANTERIOR
