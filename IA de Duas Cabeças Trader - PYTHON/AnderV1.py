...
DIFF_MODEL_DIR = "Otimizacao/treino_principal/models/ANDER"
DIFF_CHECKPOINT_DIR = "Otimizacao/treino_principal/checkpoints/ANDER"
DIFF_ENVSTATE_DIR = "trading_framework/training/checkpoints/ANDER"
...
class TradingEnv(gym.Env):
    ...
    def __init__(self, df, window_size=20, is_training=True, initial_balance=1000, trading_params=None):
        ...
        self.max_lot_size = 0.3   # Aumentado para banca $1000
        ...
        #  POSITION SIZING PARA BANCA $1000
    ...
    def train(self):
        ...
        try:
            ...
            class RobustSaveCallback(BaseCallback):
                def __init__(self, save_freq=50000, save_path=DIFF_MODEL_DIR, name_prefix="ANDER", total_steps_offset=0, training_env=None):
                    super().__init__()
        ...
        for checkpoint_dir in checkpoint_dirs:
            if os.path.exists(checkpoint_dir):
                for file in os.listdir(checkpoint_dir):
                    if file.endswith('.zip') and ('headv6' in file.lower() or 'checkpoint' in file.lower()):
