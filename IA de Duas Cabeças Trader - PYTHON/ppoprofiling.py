# 🏗️ PPO PROFILING VERSION - PROFILING EM TEMPO REAL
import sys
import os
import codecs
import cProfile
...
class TradingEnv(gym.Env):
    ...
    def _get_vectorized_temporal_features(self, seq_len):
        ...
        try:
            ...
            # 🚀 CACHE: Armazenar resultado para evitar recálculos
        ...
        try:
            ...
            for phase_idx in range(self.current_phase_idx, total_phases):
                ...
                base_callbacks = [
                    ...
                    profiling_callback,     # 🔥 NOVO: PPO Profiling completo em tempo real
    ...
    def _create_model(self, env):
        ...
        if checkpoint_path:
            ...
            try:
                ...
                # 🚀 GPU FIX: Garantir modelo carregado está no device correto
                model = model.to(device_policy)
                print(f"✅ GPU FIX: Modelo carregado movido para {device_policy}")
        ...
        model_config = {
            ...
            "env": env,
            "learning_rate": BEST_PARAMS["learning_rate"],  # 🎯 USANDO BEST_PARAMS: 3e-05
        ...
        print(f"✅ GPU FIX: Modelo criado no device {device_policy}")
...
def print_gold_spec_banner():
    """🎯 Exibe banner do sistema PPO PROFILING"""
    print("\n" + "🔍" * 60)
    print("🔍 PPO PROFILING - PROFILING EM TEMPO REAL COMPLETO")
    print("🔍" * 60)
    print("🎯 TARGET: Trader excepcional para GOLD (GC_YAHOO)")
    print(f"📊 TRAINING: {TRAINING_CONFIG['total_timesteps']/1000000:.1f}M steps - COM PROFILING COMPLETO")
    print("🏅 GOALS: Win Rate >55%, Profit Factor >1.5, Sharpe >1.2")
    print("🔍 PROFILING: CPU, Memory, GPU, Function bottlenecks")
    print("🔍" * 60)
    
    print("\n🔍 PROFILING EM TEMPO REAL:")
    print("  ✅ VELOCIDADE: Steps/sec, tempo por step, bottlenecks")
    print("  ✅ RECURSOS: CPU, Memory, GPU usage tracking")
    print("  ✅ FUNÇÕES: Top 10 funções mais custosas")
    print("  ✅ RELATÓRIOS: A cada 30 segundos automaticamente")
...
class RealTimeProfiler:
    """
    🔥 PROFILER EM TEMPO REAL COMPLETO PARA PPO
    ...
    def __init__(self):
        ...
        print("🔍 PPO PROFILER EM TEMPO REAL INICIADO!")
    ...
    def generate_realtime_report(self, step_count):
        ...
        print("\n" + "📊" * 80)
        print(f"📊 PPO PROFILING REPORT - Step {step_count} - {datetime.now().strftime('%H:%M:%S')}")
        print("📊" * 80)
        ...
        if len(self.step_times) > 10:
            ...
            print(f"🚀 VELOCIDADE DE TREINAMENTO PPO:")
        ...
        if self.is_profiling:
            ...
            print(f"\n🐌 TOP PPO BOTTLENECKS (by cumulative time):")
...
class ProfilingCallback(BaseCallback):
    """
    🔍 Callback para PROFILING EM TEMPO REAL durante treinamento PPO
    ...
    def _on_training_start(self) -> None:
        ...
        print("🔍 PPO PROFILING CALLBACK ATIVO - Monitorando performance em tempo real")
        self.step_start_time = time.time()
    
    def _on_training_end(self) -> None:
        """Called when training ends"""
        print("🔍 GERANDO RELATÓRIO FINAL DE PPO PROFILING...")
        self.profiler.generate_realtime_report(self.step_count)


def main():
    """Main function com sistema de treinamento Gold otimizado COM PROFILING"""
    global PROFILER
    ...
    try:
        ...
        # 🔍 CLEANUP PROFILER
        if PROFILER:
            print("\n🔍 FINALIZANDO PPO PROFILER...")
            PROFILER.cleanup()

if __name__ == "__main__":
    # 🔍 PPO PROFILING - PROFILING EM TEMPO REAL COMPLETO
    main()
