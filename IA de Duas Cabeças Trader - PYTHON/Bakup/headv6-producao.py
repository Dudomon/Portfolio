...
# Caminhos exclusivos para HEADV6 (TwoHeadV6Intelligent48h)
DIFF_MODEL_DIR = "Otimizacao/treino_principal/models/HEADV6"
DIFF_CHECKPOINT_DIR = "Otimizacao/treino_principal/checkpoints/HEADV6"
DIFF_ENVSTATE_DIR = "trading_framework/training/checkpoints/HEADV6"
...
class AdvancedTrainingSystem:
    ...
    def train(self):
        ...
        try:
            ...
            class RobustSaveCallback(BaseCallback):
                def __init__(self, save_freq=50000, save_path=DIFF_MODEL_DIR, name_prefix="HEADV6", total_steps_offset=0, training_env=None):
                    super().__init__()
                ...
                def _on_step(self) -> bool:
                    ...
                    if real_timesteps % self.save_freq == 0:
                        try:
                            ...
                            try:
                                emergency_path = f"{DIFF_ENVSTATE_DIR}/EMERGENCY_SAVE_HEADV6_{real_timesteps}.zip"
            ...
            for phase_idx in range(self.current_phase_idx, total_phases):
                ...
                robust_callback = RobustSaveCallback(
                    save_freq=50000,
                    save_path=checkpoint_path,
                    name_prefix=f"HEADV6_{phase_name}",
                    total_steps_offset=self.total_steps_completed,  #  PASSAR OFFSET CORRETO
                    training_env=env  #  CORREÇÃO CRÍTICA: Passar environment para salvar normalizer
                )
    ...
    def _find_latest_checkpoint(self):
        ...
        if not available_models:
            self.logger.info("❌ NENHUM CHECKPOINT 'HEADV6' ENCONTRADO - Iniciando treinamento do zero")
        ...
        if available_models:
            ...
            print("\n" + "="*80)
            print("🔄 RESUME TRAINING - CHECKPOINT 'HEADV6' DETECTADO")
            print("="*80)
            ...
            print("❌ NENHUM CHECKPOINT 'HEADV6' ENCONTRADO - Iniciando do zero")
            return None, None, None
