    ...
    def _on_step(self) -> bool:
        ...
        try:
            ...
            # No final do episódio - apenas em pontos específicos
                  ...
                  episode_just_reset or  # FIXADO: Apenas reset real detectado
                  current_episode_steps == episode_length):  # Exatamente no final
                # SEMPRE mostrar métricas no final/início do episódio (mais importante que intervalo)
                show_metrics = True
                if episode_just_reset:
...
REALISTIC_SLTP_CONFIG = {
    # 🚀 RANGES HÍBRIDOS OTIMIZADOS PARA TREINAMENTO - MODELO ESCOLHE DENTRO DELES
    'sl_min_points': 6,     # SL mínimo: 6 pontos
    'sl_max_points': 35,    # SL máximo: 35 pontos  
    'tp_min_points': 10,    # TP mínimo: 10 pontos
    'tp_max_points': 60,    # TP máximo: 60 pontos
