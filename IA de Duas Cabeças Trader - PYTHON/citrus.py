...
class EarlyStoppingCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        # 🛡️ EARLY STOPPING ATIVO - Previne overfitting
        # Só verificar após mínimo de steps
        ...
        try:
            ...
            if checkpoint_path_found and os.path.exists(checkpoint_path_found):
                ...
                try:
                    ...
                    # 🛑 VALIDAÇÃO CRÍTICA: Garantir TwoHeadV11Sigmoid após resume
    ...
    def _create_model(self, env):
        ...
        if checkpoint_path:
            ...
            try:
                ...
                # 🛑 VALIDAÇÃO CRÍTICA: Garantir TwoHeadV11Sigmoid após carregar checkpoint
        ...
        # 🚀 CONFIGURAÇÕES ESPECIALIZADAS PARA TWOHEADV11SIGMOID - SISTEMA V11 OTIMIZADO
        model_config = {
            ...
            "policy_kwargs": {
                **get_v11_sigmoid_kwargs(),
                # V8 não precisa de critic_learning_rate separado - usa LR unificado
            }
        ...
        self.logger.info(f"🚀 TwoHeadV11Sigmoid: Sistema V11 com Sigmoid Activation + Arquitetura Otimizada")
        ...
        # 🛑 VALIDAÇÃO CRÍTICA: Garantir TwoHeadV11Sigmoid
        validate_v11_sigmoid_policy(model.policy)
